...
- [ ] [Feature] [Bot] Implement `/restart` command [Ref: docs/specs/parallel_kilo_dispatch_spec.md] [Difficulty: 3]
...
- [ ] [Feature] [Testing] Add `/restart` regression tests [Ref: docs/specs/parallel_kilo_dispatch_spec.md] [Difficulty: 2]
  - **Summary:** Tests for restart handler, lock cleanup, BOT_COMMANDS update.
  - **File(s):** scripts/bot/bot.test.js
  - **Dependencies:** Requires `/restart` command.
  - **Acceptance:** `npm test` passes with new tests.
- [ ] [Feature] [Infra] Create external watchdog script + launchd plist [Ref: docs/specs/parallel_kilo_dispatch_spec.md] [Difficulty: 4]
...
- [ ] [Feature] [Bot] Add `/watchdog` status command + tests [Ref: docs/specs/parallel_kilo_dispatch_spec.md] [Difficulty: 3]
